  ...
  <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
    ...
    <div class="text-center mb-12 md:mb-16">
      <h2 class="text-3xl md:text-4xl lg:text-5xl font-semibold text-foreground mb-4">
        Mengapa Memilih <span class="text-[var(--primary)]">Ero Tour</span>?
      </h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
      @foreach ($features as $index => $feature)
        <x-ui.card
          class="p-6 text-center hover:-translate-y-1 transition-transform duration-300 border-l-4 border-l-[var(--primary)]"
          data-testid="card-feature-{{ $index }}"
        >
          <div class="w-14 h-14 mx-auto mb-4 rounded-full bg-[var(--secondary)] flex items-center justify-center">
            <x-ui.icon
              name="{{ $feature['icon'] }}"
